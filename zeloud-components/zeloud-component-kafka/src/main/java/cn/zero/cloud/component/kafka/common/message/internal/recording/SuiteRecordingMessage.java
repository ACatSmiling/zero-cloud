package cn.zero.cloud.component.kafka.common.message.internal.recording;

import cn.zero.cloud.component.kafka.common.constants.ActorInfo;
import cn.zero.cloud.component.kafka.common.constants.recording.SuiteRecordingServiceType;
import cn.zero.cloud.component.kafka.common.constants.type.KafkaEventListType;
import cn.zero.cloud.component.kafka.common.constants.type.ResourceType;
import cn.zero.cloud.component.kafka.common.constants.type.actiontype.RecordingActionType;
import cn.zero.cloud.component.kafka.common.event.KafkaBusinessEvent;
import cn.zero.cloud.component.kafka.common.message.internal.BaseInternalMessage;
import cn.zero.cloud.component.kafka.common.message.pojo.OwnerUserInfo;
import cn.zero.cloud.component.kafka.common.message.pojo.RecordingMetaData;
import cn.zero.cloud.component.kafka.common.message.util.validator.NotNullUnderConditions;
