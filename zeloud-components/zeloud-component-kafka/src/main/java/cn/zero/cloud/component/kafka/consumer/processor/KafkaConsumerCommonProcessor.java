package cn.zero.cloud.component.kafka.consumer.processor;

import cn.zero.cloud.component.kafka.common.event.KafkaBusinessEvent;
import cn.zero.cloud.component.kafka.common.exception.KafkaMessageParseException;
import cn.zero.cloud.component.kafka.common.exception.KafkaMessageValidationException;
import cn.zero.cloud.component.kafka.common.exception.error.ErrorCode;
import cn.zero.cloud.component.kafka.common.exception.error.ErrorDetail;
import cn.zero.cloud.component.kafka.common.exception.error.ErrorSummary;
import cn.zero.cloud.component.kafka.common.exception.error.ErrorType;
import cn.zero.cloud.component.kafka.common.message.BaseMessage;
import cn.zero.cloud.component.kafka.common.message.MessageVersion;
import cn.zero.cloud.component.kafka.common.message.util.parser.MessageParser;
import cn.zero.cloud.component.kafka.common.message.util.validator.MessageValidator;
...
import cn.zero.cloud.component.kafka.common.telemetry.factory.KafkaConsumerTelemetryLogFactory;
import cn.zero.cloud.component.kafka.common.telemetry.pojo.KafkaConsumerTelemetryLog;
import cn.zero.cloud.component.kafka.consumer.healthcheck.component.KafkaConsumerHealthCheck;
...
public abstract class KafkaConsumerCommonProcessor<T extends BaseMessage> {
    ...
    private boolean consumeResultIsNull(ConsumeResult consumeResult, KafkaConsumerTelemetryLog telemetryLog) {
        if (consumeResult == null || consumeResult.getResult() == null) {
            ...
            try {
                telemetryLogStr = ZeloudJsonUtil.serializeToJson(telemetryLog);
            } catch (Exception e) {
