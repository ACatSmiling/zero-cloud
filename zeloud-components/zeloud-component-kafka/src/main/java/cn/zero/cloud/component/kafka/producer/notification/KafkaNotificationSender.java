package cn.zero.cloud.component.kafka.producer.notification;

import cn.zero.cloud.component.kafka.common.exception.KafkaProducerException;
...
import cn.zero.cloud.component.kafka.producer.KafkaClientState;
import cn.zero.cloud.component.kafka.producer.cache.KafkaSenderCacheName;
import cn.zero.cloud.component.kafka.producer.ratelimit.KafkaSenderRatelimiter;
import cn.zero.cloud.component.kafka.producer.resending.client.Resender;
import cn.zero.cloud.component.kafka.producer.telemetry.ProducerTelemetryLogFactory;
...
public class KafkaNotificationSender {
    ...
    private void send(BaseMessage message, String topic, Iterable<Header> headers) {
        ...
        try {
            ...
            int byteSize = KafkaCommonUtil.getKafkaHeaderString(record.headers()).getBytes().length + ZeloudJsonUtil.serializeToJson(message).getBytes().length;
