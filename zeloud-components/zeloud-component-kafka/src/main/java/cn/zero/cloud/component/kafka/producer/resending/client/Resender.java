package cn.zero.cloud.component.kafka.producer.resending.client;

import cn.zero.cloud.component.kafka.common.exception.KafkaProducerException;
import cn.zero.cloud.component.kafka.producer.resending.Message;
import cn.zero.cloud.component.kafka.producer.resending.ResendingConstants;
...
public interface Resender {
    ...
    class Default implements Resender {
        ...
        public ResponseEntity<String> resendMessage(ProducerRecord producerRecord) throws KafkaProducerException {
            ...
            String messageBody;
            try {
                messageBody = ZeloudJsonUtil.serializeToJson(producerRecord.value());
            } catch (Exception e) {
        ...
        private String buildRequestBody(Message message) throws KafkaProducerException {
            ...
            String result = "";
            try {
                result = ZeloudJsonUtil.serializeToJson(message);
            } catch (Exception e) {
