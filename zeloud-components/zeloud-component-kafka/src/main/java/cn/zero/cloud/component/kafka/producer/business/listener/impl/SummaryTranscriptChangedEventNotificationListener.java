package cn.zero.cloud.component.kafka.producer.business.listener.impl;

import cn.zero.cloud.component.kafka.common.message.internal.summary.SummaryTranscriptChangedEventMessage;
import cn.zero.cloud.component.kafka.producer.business.event.AbstractSummaryTranscriptChangeEvent;
import cn.zero.cloud.component.kafka.producer.business.listener.AbstractEventListener;
import cn.zero.cloud.component.kafka.producer.business.service.SummaryTranscriptChangedEventNotificationService;
...
public class SummaryTranscriptChangedEventNotificationListener extends AbstractEventListener<AbstractSummaryTranscriptChangeEvent> {
    ...
    protected void onEvent(AbstractSummaryTranscriptChangeEvent event) {
        ...
        log.info("Listener summary transcript changed message event, detail: {}", ZeloudJsonUtil.serializeToJson(message));
