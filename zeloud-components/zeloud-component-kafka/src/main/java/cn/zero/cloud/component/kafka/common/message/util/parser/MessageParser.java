package cn.zero.cloud.component.kafka.common.message.util.parser;
...
import cn.zero.cloud.component.kafka.common.message.util.threadlocal.MessageThreadLocal;
...
public class MessageParser<T extends BaseMessage> {
    ...
    public T parse(String recordKey, String recordValue, Headers recordHeaders, Class<T> messageClazz) throws KafkaMessageParseException {
        try {
            T message = ZeloudJsonUtil.deserializeToClassType(recordValue, messageClazz);
