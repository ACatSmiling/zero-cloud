package cn.zero.cloud.component.kafka.config;
...
public class KafkaConfigPrinterConfig implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        LOGGER.info("Kafka Consumer Configurations: {}", ZeloudJsonUtil.serializeToJson(consumerProperties));

        // 打印生产者配置
        Map<String, Object> producerProperties = kafkaProperties.buildProducerProperties(null);
        LOGGER.info("Kafka Producer Configurations: {}", ZeloudJsonUtil.serializeToJson(producerProperties));
    }
}
