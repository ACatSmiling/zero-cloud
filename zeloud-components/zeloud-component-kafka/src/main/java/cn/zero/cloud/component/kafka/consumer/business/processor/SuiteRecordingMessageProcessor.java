package cn.zero.cloud.component.kafka.consumer.business.processor;
...
import cn.zero.cloud.component.kafka.consumer.business.service.SuiteRecordingMessageService;
import cn.zero.cloud.component.kafka.consumer.healthcheck.component.KafkaConsumerHealthCheck;
import cn.zero.cloud.component.kafka.consumer.processor.KafkaConsumerCommonProcessor;
    ...
    protected Map<String, ConsumeResult> process(List<SuiteRecordingMessage> messages) {
        ...
        List<SuiteRecordingMessage> suiteRecordingMessages = messages.stream()
                .peek(suiteRecordingMessage ->
                        log.info("Consume all suiteRecording message, message body: {}", ZeloudJsonUtil.serializeToJson(suiteRecordingMessage)))
