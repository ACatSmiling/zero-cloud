...
import cn.zero.cloud.component.kafka.producer.business.service.SummaryChangedEventNotificationService;
...
public class SummaryChangedEventNotificationListener extends AbstractEventListener<AbstractSummaryChangeEvent> {
    ...
    protected void onEvent(AbstractSummaryChangeEvent event) {
        ...
        log.info("Listener summary changed message event, detail: {}", ZeloudJsonUtil.serializeToJson(message));
