package cn.zero.cloud.component.thread.core.task;
...
import cn.zero.cloud.component.thread.core.telemetry.ThreadPoolExecuteTelemetryLog;
import cn.zero.cloud.component.thread.core.utils.SpringApplicationContextUtil;
...
public class DelegatingContextTask<V> implements Callable<V>, Runnable {
    ...
    private void writeTelemetryLog(boolean isCallerThread, Long startTime, Exception exception) {
        ...
        telemetryLog.setFeatureName(poolName);
