package cn.zero.cloud.platform.task.registrar;

import cn.zero.cloud.platform.excutor.DelegatingContextThreadPoolTaskExecutor;
import cn.zero.cloud.platform.task.collector.CommonTaskCollector;
import cn.zero.cloud.platform.task.collector.impl.MultipleThreadTaskCollector;
import cn.zero.cloud.platform.task.collector.impl.SingleThreadTaskCollector;
